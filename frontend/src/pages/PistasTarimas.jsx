...
const PistasTarimas = () => {
  ...
  const handleMantenimientoAction = async (actionType) => {
    ...
    try {
      if (actionType === 'enviar') {
        await enviarAMantenimiento('pistas-tarimas', item.id, parseInt(cantidad));
      } else if (actionType === 'reintegrar') {
        await reintegrarDeMantenimiento('pistas-tarimas', item.id, parseInt(cantidad));
      }
      fetchItems();
  ...
  return (
    <div className="category-container">
      <h1>Gestión de Pistas y Tarimas</h1>
